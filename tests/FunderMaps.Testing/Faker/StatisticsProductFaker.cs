...
namespace FunderMaps.Testing.Faker
{
    ...
    public class StatisticsProductFaker : Faker<StatisticsProduct>
    {
        ...
        public StatisticsProductFaker()
        {
            ...
            RuleFor(f => f.DataCollectedPercentage, f => f.Random.Int(0, 100));
            ...
            RuleFor(f => f.TotalBuildingRestoredCount, f => f.Random.Int(0, 100));
            RuleFor(f => f.TotalIncidentCount, f => f.Random.Int(0, 100));
            RuleFor(f => f.TotalReportCount, f => f.Random.Int(0, 100));
        }
        ...
        private static FoundationRiskDistribution CreateFoundationRiskDistribution()
        {
            ...
            result.PercentageA = (decimal)random.NextDouble() * 100;
            result.PercentageB = (decimal)random.NextDouble() * (100 - result.PercentageA);
            result.PercentageC = (decimal)random.NextDouble() * (100 - (result.PercentageA + result.PercentageB));
            result.PercentageD = (decimal)random.NextDouble() * (100 - (result.PercentageA + result.PercentageB + result.PercentageC));
