...
namespace FunderMaps.Testing.Repositories
{
    ...
    public class TestStatisticsRepository : IStatisticsRepository
    {
        ...
        public async Task<ConstructionYearDistribution> GetConstructionYearDistributionByIdAsync(Guid userId, string neighboorhoodId)
        {
        ...
        public async Task<double> GetDataCollectedPercentageByIdAsync(Guid userId, string neighboorhoodId)
        {
            await Task.CompletedTask;
        ...
        public async Task<FoundationRiskDistribution> GetFoundationRiskDistributionByIdAsync(Guid userId, string neighboorhoodId)
        {
            await Task.CompletedTask;
        ...
        public async Task<FoundationTypeDistribution> GetFoundationTypeDistributionByIdAsync(Guid userId, string neighboorhoodId)
        {
            await Task.CompletedTask;
        ...
        public async Task<uint> GetTotalBuildingRestoredCountByIdAsync(Guid userId, string neighboorhoodId)
        {
            await Task.CompletedTask;
        ...
        public async Task<uint> GetTotalIncidentCountByIdAsync(Guid userId, string neighboorhoodId)
        {
            await Task.CompletedTask;
        ...
        public async Task<uint> GetTotalReportCountByIdAsync(Guid userId, string neighboorhoodId)
        {
            await Task.CompletedTask;
