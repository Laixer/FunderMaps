...
namespace FunderMaps.Webservice.UnitTests
{
    // TODO Can automapper build testcases?
    /// <summary>
    ///     Contains explicit enum mapping becuase our mapping service under
    ///     test uses implicit AutoMapper enum mapping.
    /// </summary>
    internal static class EnumMapperHelper
    {
