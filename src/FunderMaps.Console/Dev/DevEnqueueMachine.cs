...
namespace FunderMaps.Console.Dev
{
    ...
    {
        private readonly DispatchManager _queueManager;

        public DevEnqueueMachine(DispatchManager queueManager)
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            _queueManager.EnqueueTask(new BundleBuildingContext
            {
                ...
                Formats = new GeometryExportFormat[]
                {
                    GeometryExportFormat.Gpkg
                },
            });
