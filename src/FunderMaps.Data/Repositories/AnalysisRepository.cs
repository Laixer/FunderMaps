...
internal sealed class AnalysisRepository : DbServiceBase, IAnalysisRepository
{
    ...
    public static AnalysisProduct3 MapFromReader3(DbDataReader reader)
        => new()
        {
            ...
            Owner = reader.GetSafeString(16),
            Drystand = reader.GetSafeDouble(17),
            DrystandRisk = reader.GetFieldValue<FoundationRisk?>(18),
            DrystandReliability = reader.GetFieldValue<Reliability>(19),
            BioInfectionRisk = reader.GetFieldValue<FoundationRisk?>(20),
            BioInfectionReliability = reader.GetFieldValue<Reliability>(21),
            DewateringDepth = reader.GetSafeDouble(22),
            DewateringDepthRisk = reader.GetFieldValue<FoundationRisk?>(23),
            DewateringDepthReliability = reader.GetFieldValue<Reliability>(24),
            UnclassifiedRisk = reader.GetFieldValue<FoundationRisk?>(25),
            RecoveryType = reader.GetFieldValue<RecoveryType?>(26),
        };
}
