    ...
    public async Task<AnalysisProduct> GetAsync(string id)
    {
        var sql = @"
            SELECT
                    ...
                    mrs.drystand,
                    mrs.drystand_risk,
                    mrs.drystand_risk_reliability AS drystand_reliability,
                    mrs.bio_infection_risk,
                    mrs.bio_infection_risk_reliability AS bio_infection_reliability,
                    mrs.dewatering_depth,
                    mrs.dewatering_depth_risk,
                    mrs.dewatering_depth_risk_reliability AS dewatering_depth_reliability,
